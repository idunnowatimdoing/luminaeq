      ...
      <div className="container mx-auto px-4">
        <div className="backdrop-blur-lg bg-white/30 rounded-2xl shadow-lg p-8 border border-white/20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="backdrop-blur-md bg-white/40 p-8 border-lumina-teal/20 group hover:shadow-lg transition-all duration-300">
              <div className="flex items-center justify-center mb-6">
                <Users className="w-12 h-12 text-lumina-teal group-hover:scale-110 transition-transform" />
              </div>
              <h3 className="text-2xl font-semibold mb-4 text-lumina-blue">Lumina Connect</h3>
              <p className="text-lumina-dark mb-4">
              ...
              <ul className="text-lumina-neutral space-y-2">
            ...
            <Card className="backdrop-blur-md bg-white/40 p-8 border-lumina-yellow/20 group hover:shadow-lg transition-all duration-300">
              <div className="flex items-center justify-center mb-6">
                <BookOpen className="w-12 h-12 text-lumina-yellow group-hover:scale-110 transition-transform" />
              </div>
              <h3 className="text-2xl font-semibold mb-4 text-lumina-blue">Community Journal</h3>
              <p className="text-lumina-dark mb-4">
