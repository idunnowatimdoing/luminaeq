    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        <div className="backdrop-blur-lg bg-white/30 rounded-2xl shadow-lg p-8 border border-white/20">
          <h2 className="text-4xl font-bold text-center mb-12 text-lumina-blue relative">
          ...
          <div className="max-w-3xl mx-auto text-center mb-12">
            <p className="text-lg text-lumina-dark mb-6 leading-relaxed">
            ...
            <p className="text-lg text-lumina-neutral mb-8">
              Studies show people with high EQ earn 29% more annually and report higher job satisfaction.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-12">
              <Card className="backdrop-blur-md bg-white/40 p-6 border-lumina-teal/20 hover:shadow-lg transition-all duration-300 group">
                <div className="flex items-center justify-center mb-4">
                  <TrendingUp className="w-8 h-8 text-lumina-teal group-hover:scale-110 transition-transform" />
                </div>
                <h3 className="font-semibold mb-2 text-lumina-blue">Better Performance</h3>
                <p className="text-lumina-neutral">90% of top performers have high EQ</p>
              </Card>
              <Card className="backdrop-blur-md bg-white/40 p-6 border-lumina-yellow/20 hover:shadow-lg transition-all duration-300 group">
                <div className="flex items-center justify-center mb-4">
                  <Brain className="w-8 h-8 text-lumina-yellow group-hover:scale-110 transition-transform" />
                </div>
                <h3 className="font-semibold mb-2 text-lumina-blue">Growth Potential</h3>
                <p className="text-lumina-neutral">Unlike IQ, your EQ can be strengthened over time</p>
              </Card>
            </div>
          </div>
        </div>
